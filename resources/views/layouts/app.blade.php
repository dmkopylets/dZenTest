...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $metaTitle ?: "TheUncleDima`s Blog" }}</title>
        <meta name="author" content="Uncle Dima">
        <meta name="description" content="{{ $metaDescription }}">

        <style>
            @import url('{{ asset('css/karlaFonts.css') }}?family=Karla:400,700&display=swap');
        </style>
...
<footer class="w-full border-t bg-white pb-12">
    <div class="w-full container mx-auto flex flex-col items-center">
        <div class="uppercase pb-6">&copy; uncle.dima.blog.com</div>
    </div>
</footer>
