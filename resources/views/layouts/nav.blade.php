            ...
            <div class="row g-2">
                <div class="col-md">
                    <div class="form-floating">
                        <input type="email" class="form-control" id="email" name="email" placeholder="{{ $signedUser['email'] }}" value="{{ $signedUser['email'] }}">
                        <label for="email">Email address</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="User_Name" name="User_Name" placeholder="{{ $signedUser['name'] }}" value="{{ $signedUser['name'] }}">
                        <label for="User_Name">User name</label>
                    </div>
                </div>
            </div>
            <div class="d-flex" style="float: right; margin-left: 100px;">">
                <div>
